...
public class MomoiHaloItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public MomoiHaloItem(RegistryEntry<ArmorMaterial> material, ArmorItem.Type type, Item.Settings settings) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private GeoArmorRenderer<MomoiHaloItem> renderer;
